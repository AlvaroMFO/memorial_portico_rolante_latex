...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{content/sections/03_sistema_de_elevacao/sections/01_dimensionamento_do_cabo_de_aco/sections/04_diametro_do_cabo_de_aco/figures/coeficiente_q.pdf}
  \caption{Valores Mínimos de Q \cite[p.~34]{nbr8400}}
...
Adotou-se um cabo de aço CIMAF, classe 6x41 Warrington-Seale IPS, com alma de fibra. As propriedades do cabo, conforme o catálogo da CIMAF, são:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{content/sections/03_sistema_de_elevacao/sections/01_dimensionamento_do_cabo_de_aco/sections/04_diametro_do_cabo_de_aco/figures/propriedades_cabos_cimaf.pdf}
  \caption{Propriedades dos cabos de aço \cite[p.~62]{cimaf_cabos_aco}}
  \label{fig:propriedades_cabos_cimaf}
\end{figure}

Para um cabo de \SI{14.5}{\milli\meter}, a carga de ruptura mínima é de \SI{12.5}{\tonneforce}.

Segundo o catálogo da CIMAF, o fator de segurança deve ser de $6$ a $8$ para pontes rolantes, aplicável também a pórticos rolantes. Os valores recomendados são:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{content/sections/03_sistema_de_elevacao/sections/01_dimensionamento_do_cabo_de_aco/sections/04_diametro_do_cabo_de_aco/figures/fator_seguranca_cimaf.pdf}
  \caption{Fatores de segurança \cite[p.~23]{cimaf_cabos_aco}}
  \label{fig:fator_seguranca_cimaf}
\end{figure}

No catálogo da CIMAF, o fator de segurança é definido pela seguinte equação:
...
\begin{itemize}[leftmargin=1.25cm]
  ...
  \item $T$: força de tração no cabo em $\si{\tonneforce}$ \eqref{eq:forca_de_tracao_no_cabo}.
\end{itemize}
...
\begin{align*}
  F_s & = \frac{\num{12.5}}{\num{2537.78} \cdot 10^{-3}}         \\
  F_s & = \boxed{\num{4.93}} \leq 6 \rightarrow \text{Reprovado}
\end{align*}
...
\begin{align*}
  F_s & = \frac{\num{15.2}}{\num{2537.78} \cdot 10^{-3}}         \\
  F_s & = \boxed{\num{5.99}} \leq 6 \rightarrow \text{Reprovado}
\end{align*}
...
\begin{align*}
  F_s & = \frac{22}{\num{2537.78} \cdot 10^{-3}}          \\
  F_s & = \boxed{\num{8.67}} \geq 6 \rightarrow \text{OK}
\end{align*}
...
\begin{table}[H]
  ...
  \label{tab:propriedades_cabo_adotado}
