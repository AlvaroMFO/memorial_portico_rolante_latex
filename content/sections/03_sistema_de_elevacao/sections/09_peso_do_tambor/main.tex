...
\begin{itemize}[leftmargin=1.25cm]
  ...
  \item $L_t$: comprimento do tambor, convertido para $\si{\meter}$.
  \item $m_{\text{tubo}}$: massa do tubo por metro em $\si{\kilo\gram/\meter}$.
\end{itemize}
...
\begin{align*}
  ...
  M_{\text{tubo}} & = \SI{411,08}{\kilo\gram}
\end{align*}
...
\begin{itemize}[leftmargin=1.25cm]
  ...
  \item $D_t$: diâmetro externo do tubo, convertido para $\si{\meter}$.
\end{itemize}
...
\begin{align*}
  ...
  M_{\text{chapa}} & = \SI{29,71}{\kilo\gram}
\end{align*}
