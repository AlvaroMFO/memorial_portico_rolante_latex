...
Assim, podemos extrair os valores de momento fletor máximo e a força cortante máxima no tambor e também o momento fletor e a força cortante no eixo (posição $x = \SI{0,1}{\meter}$). Os dados obtidos são:
