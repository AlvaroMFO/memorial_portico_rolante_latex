...
\begin{figure}[H]
  ...
  \caption{Catálogo de freios de sapata da EMH \cite{emh_freios}}
...
\begin{figure}[H]
  ...
  \caption{Dados da polia do freio adotado segundo o catálogo da EMH \cite{emh_freios}}
  \label{fig:freio_polia}
\end{figure}

\begin{table}[H]
  \centering
  \caption{Dados do freio adotado segundo o catálogo da EMH \cite{emh_freios}}
