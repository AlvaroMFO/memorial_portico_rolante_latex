...
\begin{figure}[H]
  ...
  \caption{Valores de $H_1$ \cite{nbr8400}}
...
\begin{figure}[H]
  ...
  \caption{Valores de $H_2$ \cite{nbr8400}}
...
\begin{figure}[H]
  ...
  \caption{Exemplo de $W_T$ para um moitão de 4 cabos \cite{nbr8400}}
  \label{fig:moitao_wt}
\end{figure}

Para o grupo de mecanismo 1AM e cabo normal, adotou-se $W_T = 1,12$.
Com isso, obtiveram-se os seguintes valores para os coeficientes $H_1$ e $H_2$:

\begin{table}[H]
  \centering
  \caption{Coeficientes $H_1$ e $H_2$ obtidos segundo a NBR 8400 \cite{nbr8400}}
...
Com base no catálogo de polias da BOHMER \cite{bohmer_polias}, adotaram-se polias com diâmetro de \SI{500}{\milli\meter}, para cabos de \SI{20}{\milli\meter}. O tipo selecionado foi o de polia para moitão inferior com duas roldanas, conforme a DIN 15408. Como o catálogo não informa o peso unitário, adotou-se \SI{80}{\kilo\gram} por polia. As polias selecionadas são apresentadas a seguir:
...
\begin{figure}[H]
  ...
  \caption{Polias do catálogo da BOHMER \cite{bohmer_polias}}
