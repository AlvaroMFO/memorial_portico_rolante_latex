...
Considerou-se um fator de serviço $K = 1,25$ com base na tabela do catálogo de acoplamentos da Gosan para o grupo do mecanismo $1AM$.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{content/sections/03_sistema_de_elevacao/sections/15_acoplamento_redutor_tambor/images/k_gosan.png}
...
\begin{align*}
  M & = \frac{32}{10} \cdot 955 \cdot 1,25    \\
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{content/sections/03_sistema_de_elevacao/sections/15_acoplamento_redutor_tambor/images/catalogo_gosan.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{content/sections/03_sistema_de_elevacao/sections/15_acoplamento_redutor_tambor/images/flange_gosan.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{content/sections/03_sistema_de_elevacao/sections/15_acoplamento_redutor_tambor/images/dim_flange_gosan.png}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X}
    ...
    Espessura mínima do flange     & $e_{\text{min}}$ & \SI{30}{\milli\meter}         \\
    \bottomrule
  \end{tabularx}
\end{table}

O tambor adotado possui um diâmetro interno de $\SI{307,94}{\milli\meter}$, que está adequado ao diâmetro interno definido no catálogo do acomplamento de $\SI{310}{\milli\meter}$.
