...
\begin{align*}
  M_{\text{tubo}} & = 2112 \cdot 10^{-3} \cdot \num{194.64} \\
...
\begin{align*}
  A_f & = \frac{\pi \cdot {\left(\num{355.6} \cdot 10^{-3}\right)}^2}{4} \\
...
\begin{equation}
  G_{\text{tambor}} = \left(M_{\text{tubo}} + M_{\text{chapa}}\right) \cdot g \cdot \num{1.5}
