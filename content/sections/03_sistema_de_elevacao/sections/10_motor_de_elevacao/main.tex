...
Adotou-se $\eta_{\text{moitão}} = 0,9925$, conforme a equação \eqref{eq:rendimento_moitao}. Para o redutor, adotou-se $\eta_{\text{redutor}} = 0,94$, segundo o fabricante WEG Cestari \cite{weg_cestari_redutores}. Para os mancais, adotou-se $\eta_{\text{mancal}} = 0,985$.
...
Com base no catálogo de motores elétricos da WEG \cite{weg}, selecionou-se um motor trifásico à prova de explosão de \SI{11}{\kilo\watt} (\SI{15}{\cv}) e \SI{1170}{\rpm}, na carcaça 160L. As figuras e a tabela a seguir apresentam os dados extraídos do catálogo para o motor adotado.
