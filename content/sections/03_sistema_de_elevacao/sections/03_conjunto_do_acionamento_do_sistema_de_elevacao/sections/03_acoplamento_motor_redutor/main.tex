...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{content/sections/03_sistema_de_elevacao/sections/03_conjunto_do_acionamento_do_sistema_de_elevacao/sections/03_acoplamento_motor_redutor/figures/acoplamento_motor_redutor.pdf}
