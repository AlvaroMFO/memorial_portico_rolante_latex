Para dimensionar as vigas de ligação, realizou-se a modelagem estática considerando apenas peso e apenas carga.

Os dados obtidos nas modelagens foram:

\begin{table}[H]
  \centering
  \caption{Dados obtidos nas modelagens}
...
\begin{align*}
  \sigma_M & = m_x \cdot \left( \frac{M_G}{I_z} \cdot y + \psi \cdot \frac{M_L}{I_z} \cdot y \right)                                                                          \\
  \sigma_M & = 1 \cdot \left( \frac{\num{1462.58}}{\num{1.72289e-5}} \cdot \num{105e-3} + \num{1.15} \cdot \frac{\num{15461.43}}{\num{1.72289e-5}} \cdot \num{105e-3} \right) \\
  \sigma_M & = \boxed{\SI{117.276}{\mega\pascal}}
\end{align*}
